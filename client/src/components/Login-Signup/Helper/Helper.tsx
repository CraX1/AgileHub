...
export const socialMediaOptionWrapper = (
  ...
  <p className="flex gap-2 justify-center items-center flex-grow border border-solid rounded-md border-gray-200 px-12 py-3 cursor-pointer hover:bg-proj_blue-light hover:border-proj_blue-lightBorder transition-colors">
    {platformIcon}
    {platform}
  </p>
);
